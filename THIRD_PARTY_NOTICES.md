...
- The Codex adapter asks macOS for the Codex icon resource from an installed application with bundle identifier
  `com.openai.codex`. Cappy does not copy or redistribute that icon. Codex and OpenAI are trademarks of OpenAI, L.L.C.

Use of these marks does not imply endorsement, sponsorship, or affiliation.
